...
export const styles = StyleSheet.create({
  ...
  alertMessage: { fontFamily: 'determination', color: '#8a94a6', fontSize: 14, textAlign: 'center', marginBottom: 20, lineHeight: 20 },
  alertMessageSuccess: { fontFamily: 'determination', color: '#2ecc71', fontSize: 14, textAlign: 'center', marginBottom: 20 },
  ...
  alertButtonText: { fontFamily: 'determination', color: '#ebd59b', fontSize: 13, letterSpacing: 0.5 },
  alertButtonTextCancel: { fontFamily: 'determination', color: '#e74c3c', fontSize: 13, letterSpacing: 0.5 }
});