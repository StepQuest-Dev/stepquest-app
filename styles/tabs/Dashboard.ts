...
export const styles = StyleSheet.create({
  ...
  expBarBg: { width: 65, height: 10, backgroundColor: '#12181f', borderWidth: 1, borderColor: '#454f5b', borderRadius: 1, overflow: 'hidden', justifyContent: 'center' },
  expBarFill: { position: 'absolute', left: 0, top: 0, bottom: 0, backgroundColor: '#717d8c', justifyContent: 'center', alignItems: 'center', minWidth: 0 },
  expBarText: { fontFamily: 'determination', color: '#fff', fontSize: 10, lineHeight: 13, textAlign: 'center', width: '100%', zIndex: 1 },
